def bin2tiffS(input_file,wavelength,output_folder,master):
    '''
        ...
        if conv_check == True:
            ...
            def update_progress_bar():
                ...
                for file in bin_files:
                    ...
                    imwrite(outfile,phase_map,compression='zstd',append=True,planarconfig='CONTIG')
